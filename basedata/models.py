...
class ValueList(generic.BO):
    ...
    module = models.ForeignKey(Module,on_delete=models.CASCADE,verbose_name=_("module"),blank=True,null=True)
    ...
    locked_by = models.ForeignKey(User,on_delete=models.CASCADE,verbose_name=_("locked by"),blank=True,null=True)
...
class ValueListItem(models.Model):
    ...
    值列表项
    """
    group = models.ForeignKey(ValueList, on_delete=models.CASCADE,verbose_name=_("list group"))
...
class BankAccount(generic.BO):
    ...
    def __str__(self):
        ...
        return "%s %s %s" % (name,self.account,self.title)
...
class Project(generic.BO):
    ...
    partner = models.ForeignKey(Partner,blank=True,null=True,on_delete=models.CASCADE,verbose_name=_("partner"),limit_choices_to={"partner_type":"C"})
...
class MaterialParam(models.Model):
    ...
    param_value = models.ForeignKey(
        TechnicalParameterValue, on_delete=models.CASCADE)
