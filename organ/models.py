...
class OrgUnit(generic.BO):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, verbose_name=_(
...
class Position(generic.BO):
    ...
    index_weight = 3
    unit = models.ForeignKey(OrgUnit, on_delete=models.CASCADE,verbose_name=_('org unit'))
