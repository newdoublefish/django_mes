    ...
    def changeform_view(self, request, object_id=None, form_url='', extra_context=None):
        ...
        if app_info:
            try:
                ...
                workflow_restart_url = "/admin/" + app_info['app'] + "/" + app_info['model'] + "/" + object_id + '/restart'
        ...
        ctx = dict(
            ...
            workflow_restart_url = workflow_restart_url,
        )
        ...
        if app_info:
            if len(self.extra_buttons) > 0:
                ...
                temp_extra_buttons = copy.deepcopy(self.extra_buttons)
                for extra_button in temp_extra_buttons:
